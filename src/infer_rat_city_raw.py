...
def infer(yaml_configs_file_name: str):
    ...
    test_array = np.delete(test_array, [4, 5, 6], axis=1)   # remove columns conf, gt_id, previous_gt_id, last column is kept  previous_yolo_id
...
if __name__ == "__main__":
    ...
    infer(yaml_configs_file_name="../experiments/configs_infer_rat_city_raw.yaml")
